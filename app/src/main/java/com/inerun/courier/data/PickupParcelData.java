...
public class PickupParcelData implements Serializable {
    ...
    private String preferred_collection_date;
    ...
    public PickupParcelData(int column_id, String parcel_barcode, String customer_id, String fname, String lname, String email, String phone, String landline, String ext, int pickup_status, PickupAddress pickup_address, PickupAddress delivery_address, PickParcelDetailData pickParcelDetailData, String vendor_name, String awb, Payment payment, Services service, Shipment shipment,String pickup_type,String preferred_collection_date) {
        ...
        this.preferred_collection_date = preferred_collection_date;
    }
    ...
    public String getPreferred_collection_date() {
        return preferred_collection_date;
    }

    public void setPreferred_collection_date(String preferred_collection_date) {
        this.preferred_collection_date = preferred_collection_date;
    }
    ...
    public String getDeliveryAddress() {
        ...
        if (Delivery_address.getAddress1() != null && Delivery_address.getAddress1().trim().length() > 0) {
            add = Delivery_address.getAddress1() + ", ";
        }
        if (Delivery_address.getAddress2() != null && Delivery_address.getAddress2().trim().length() > 0) {
            add = add + Delivery_address.getAddress2() + ", ";
        }
        if (Delivery_address.getCity() != null && Delivery_address.getCity().trim().length() > 0) {
            add = add + Delivery_address.getCity()+ ", ";
        }
        if (Delivery_address.getState() != null && Delivery_address.getState().trim().length() > 0) {
            add = add + Delivery_address.getState() + ", ";
        }
        if (Delivery_address.getCountry() != null && Delivery_address.getCountry().trim().length() > 0) {
            add = add + Delivery_address.getCountry() + ", ";
        }
        if (Delivery_address.getZipCode() != null && Delivery_address.getZipCode().trim().length() > 0) {
            add = add + Delivery_address.getZipCode() ;
        }
