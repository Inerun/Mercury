...
//        String selectQuery = "SELECT * FROM " + DataUtils.TABLE_NAME_PICKUP_DATA + " WHERE " + DataUtils.PARCEL_PICKUP_STATUS + " != " + AppConstant.StatusKeys.PICKEDUP_STATUS;
        ...
        if (cursor.moveToFirst()) {
            do {
                //Log.i("Parcel_ID", "" + cursor.getInt(0));
                PickParcelDetailData pickParcelDetailData = new PickParcelDetailData(cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13), cursor.getString(14), cursor.getString(15), cursor.getString(16), cursor.getString(17), cursor.getString(18), cursor.getString(19), cursor.getString(20), cursor.getString(62));
                PickupAddress pickupAddress = new PickupAddress(cursor.getString(21), cursor.getString(22), cursor.getString(23), cursor.getString(24), cursor.getString(25), cursor.getString(26), cursor.getString(27), cursor.getString(28), cursor.getString(29), cursor.getString(30), cursor.getString(31), cursor.getString(32), cursor.getString(34), cursor.getString(33), cursor.getString(35), cursor.getInt(36), cursor.getInt(37));
                PickupAddress pickupDeliveryAddress = new PickupAddress(cursor.getString(38), cursor.getString(39), cursor.getString(40), cursor.getString(41), cursor.getString(42), cursor.getString(43), cursor.getString(44), cursor.getString(45), cursor.getString(46), cursor.getString(47), cursor.getString(48), cursor.getString(49), cursor.getString(51), cursor.getString(50), cursor.getString(52), cursor.getInt(53), cursor.getInt(54), cursor.getInt(55));
                Payment payment = new Payment(cursor.getInt(59));
                Services services = new Services(cursor.getString(56), cursor.getString(57), cursor.getString(58));

                Shipment shipment = new Shipment(cursor.getString(60), cursor.getString(61), shipmentDao.getPickupShipmentDetailForListing(cursor.getString(1)),cursor.getString(71),cursor.getString(72),cursor.getString(70),cursor.getString(66),cursor.getString(67),cursor.getString(68),cursor.getString(69),cursor.getString(73),cursor.getString(74),cursor.getString(73),cursor.getString(78),cursor.getString(79));

                PickupParcelData pickupParcelData = new PickupParcelData(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getInt(9), pickupAddress, pickupDeliveryAddress, pickParcelDetailData, "vendor_name", cursor.getString(63), payment, services, shipment,cursor.getString(76),cursor.getString(77));
...
//        }
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                PickupParcelData pickupParcelData = new PickupParcelData(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7), cursor.getString(8), cursor.getInt(9), pickupAddress, pickupDeliveryAddress, pickParcelDetailData, "vendor_name", "awb", payment, services, shipment,cursor.getString(76),cursor.getString(77));
...
//        String selectQuery = "SELECT * FROM " + DataUtils.TABLE_NAME_PICKUP_DATA + " ORDER BY " + DataUtils.PARCEL_PICKUP_STATUS + " DESC";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Shipment shipment = new Shipment(cursor.getString(60), cursor.getString(61), shipmentDao.getPickupShipmentDetailForListing(cursor.getString(1)),cursor.getString(71),cursor.getString(72),cursor.getString(70),cursor.getString(66),cursor.getString(67),cursor.getString(68),cursor.getString(69),cursor.getString(70),cursor.getString(71),cursor.getString(72),cursor.getString(78),cursor.getString(79));
...
//                UpdatedPickupParcelData updatedParcelData = new UpdatedPickupParcelData(barcode, cursor.getInt(9), cursor.getString(20), cursor.getString(46), statusDataList);
    ...
    private String getParcelColumns() {
        ...
        String columns = "(" + DataUtils.PARCEL_BARCODE //1
                + "," + DataUtils.CUSTOMER_ID + ","  //2
                + DataUtils.USER_FNAME + ","   //3
                + DataUtils.USER_LNAME + ","    //4
                + DataUtils.USER_EMAIL + ","    //5
