...
//        db.execSQL("DROP TABLE IF EXISTS " + DataUtils.WISHLIST_TABLE_NAME);
    ...
    public static String CREATE_PICKUP_DATA_TABLE = "CREATE TABLE IF NOT EXISTS " + DataUtils.TABLE_NAME_PICKUP_DATA + "("
            ...
            + DataUtils.DELIVERY_ADDRESS_FNAME + " TEXT ,"      //35
            + DataUtils.DELIVERY_ADDRESS_LNAME + " TEXT ,"      //36
            + DataUtils.DELIVERY_ADDRESS_EMAIL + " TEXT ,"      //37
            + DataUtils.DELIVERY_ADDRESS_PHONE + " TEXT ,"      //38
            + DataUtils.DELIVERY_ADDRESS_lANDLINE + " TEXT ,"   //39
            + DataUtils.DELIVERY_ADDRESS_EXTENSION + " TEXT ,"  //40
            + DataUtils.DELIVERY_ADDRESS_ADDRESS1 + " TEXT ,"   //41
            + DataUtils.DELIVERY_ADDRESS_ADDRESS2 + " TEXT ,"   //42
            + DataUtils.DELIVERY_ADDRESS_COUNTRY + " TEXT ,"    //43
            + DataUtils.DELIVERY_ADDRESS_STATE + " TEXT ,"      //44
            + DataUtils.DELIVERY_ADDRESS_CITY + " TEXT ,"       //45
            + DataUtils.DELIVERY_ADDRESS_ZIP_CODE + " TEXT ,"   //46
            + DataUtils.DELIVERY_ADDRESS_COMPANY + " TEXT ,"    //47
            + DataUtils.DELIVERY_ADDRESS_DEPARTMENT + " TEXT ," //48

            + DataUtils.SERVICE_ID + " TEXT ,"                  //49
            + DataUtils.SERVICE_NAME + " TEXT ,"                //50
            + DataUtils.SERVICE_FREIGHT_CHARGES + " TEXT ,"     //51

            + DataUtils.PAYMENT_TYPE + " INTEGER ,"             //52

            + DataUtils.SHIPMENT_TOTAL_PIECES + " TEXT ,"       //53
            + DataUtils.SHIPMENT_WEIGHT + " TEXT ,"             //54
            + DataUtils.PAYMENT_CARD_TRANSACTION_ID + " TEXT ," //55

            + DataUtils.PICKUP_AWB + " TEXT ,"                  //56


            + DataUtils.UPDATE_STATUS + " INTEGER DEFAULT -1,"  //57
            + DataUtils.UPDATE_DATE + " TEXT "                  //58
            + ")";
    ...
    public static String CREATE_SHIPMENT_DATA_TABLE = "CREATE TABLE IF NOT EXISTS " + DataUtils.TABLE_NAME_SHIPMENT_DATA + "("
            ...
            + DataUtils.SHIPMENT_CREATED_ON + " TEXT ,"      //8
            + DataUtils.PARCEL_BARCODE + " TEXT ,"          //9
            + DataUtils.SHIPMENT_updated_on + " TEXT "       //10
            + ")";
