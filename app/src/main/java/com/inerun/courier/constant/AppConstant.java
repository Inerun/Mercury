...
//    public static final String DATEIME_FORMAT = "yyyy.MM.dd_HH.mm.ss "; //2017.01.24_06.55.14
    ...
    public static String[] requiredPermissions() {
        String[] permissions = new String[]{Manifest.permission.INTERNET, Manifest.permission.ACCESS_NETWORK_STATE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.CALL_PHONE,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_FINE_LOCATION};
        return permissions;
    }
    ...
    public static class StatusKeys {
        ...
        public static final int PAYMENT_CARD = 1; //Active
        public static final int PAYMENT_CASH = 2;
        public static final int PAYMENT_ON_ACCOUNT = 3; //Active
        public static final int PAYMENT_COD = 4; //Active
    }
