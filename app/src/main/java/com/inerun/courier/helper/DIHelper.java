...
//        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String getValueInInteger(float value){
    ...
    public static String getValueInInteger(String value){
        DecimalFormat df = new DecimalFormat("0");
        try {
            if(value != null && value.length() > 0) {
                float f = Float.parseFloat(value);
    ...
    public static String getValue4Decimal(float value){
    ...
    public static String [] getCountries(List<Country> dataList){

        String[] array = new String[dataList.size()];
        for (int i = 0; i < dataList.size(); i++) {
            Country data = dataList.get(i);
            array[i] = data.getCountry_name();

        }

        return array;
    }public static String [] getServices(List<Services> dataList){

        String[] array = new String[dataList.size()];
        for (int i = 0; i < dataList.size(); i++) {
            Services data = dataList.get(i);
            array[i] = data.getService_name();
    ...
    public static String [] getSurcharge(List<Surcharge> dataList){

        String[] array = new String[dataList.size()];
        for (int i = 0; i < dataList.size(); i++) {
            Surcharge data = dataList.get(i);
            array[i] = data.getSurcharge_name();

        }

        return array;
    }
    public static String [] getRegion(List<Region> dataList){

        String[] array = new String[dataList.size()];
        for (int i = 0; i < dataList.size(); i++) {
            Region data = dataList.get(i);
            array[i] = data.getRegion_name();
    ...
    public static String [] getCity(List<City> dataList){

        String[] array = new String[dataList.size()];
        for (int i = 0; i < dataList.size(); i++) {
            City data = dataList.get(i);
            array[i] = data.getCity_name();
    ...
    public static String [] getUnits(Context context){
        ...
        String[] array = context.getResources().getStringArray(R.array.unit_array);
//
//        String[] array = new String[dataList.size()];
//        for (int i = 0; i < dataList.size(); i++) {
//            City data = dataList.get(i);
