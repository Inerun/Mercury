...
public class CollectionWaitingListingAdapter extends BaseRecyclerViewAdapter_new implements CompoundButton.OnCheckedChangeListener {
    ...
    public CollectionWaitingListingAdapter(Context context) {
    ...
    protected View oncreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.collection_waiting_list_item, parent, false);
        return itemView;
    }
...
//        holder.parcel_id.setText(DIHelper.getBoldLabel(data.getParcel_barcode()));
        ...
        holder.assignedby.setText("Rajeev Singh");
...
//    }
    ...
    public void setOnItemClickListener(final OnItemClickListener mItemClickListener) {
        CollectionWaitingListingAdapter.mItemClickListener = mItemClickListener;
    }
