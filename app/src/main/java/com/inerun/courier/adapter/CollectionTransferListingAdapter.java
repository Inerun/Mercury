...
public class CollectionTransferListingAdapter extends BaseRecyclerViewAdapter_new implements CompoundButton.OnCheckedChangeListener {
    ...
    public CollectionTransferListingAdapter(Context context) {
    ...
    protected View oncreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.collection_transfer_list_item, parent, false);
        return itemView;
    }
...
//    }
    ...
    public void setOnItemClickListener(final OnItemClickListener mItemClickListener) {
        CollectionTransferListingAdapter.mItemClickListener = mItemClickListener;
    }
