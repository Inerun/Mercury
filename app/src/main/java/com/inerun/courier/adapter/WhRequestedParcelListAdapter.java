...
//    boolean checkenabled=false;
    ...
    public WhRequestedParcelListAdapter(WhSearchParcelFragment fragment, Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
    ...
    public WhRequestedParcelListAdapter(Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
        this.parcelDataList = parcelDataList;
        this.onclickListener = onclickListener;
        this.context = context;
