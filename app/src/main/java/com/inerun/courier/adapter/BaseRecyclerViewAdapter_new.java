...
abstract public class BaseRecyclerViewAdapter_new extends RecyclerView.Adapter<BaseRecyclerViewAdapter_new.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == LIST_EMPTY) {
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_error_layout, parent, false);
...
//        return LIST_EMPTY;
    ...
    abstract public List initObjectList();
