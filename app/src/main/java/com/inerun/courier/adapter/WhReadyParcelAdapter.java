...
public class WhReadyParcelAdapter extends RecyclerView.Adapter<WhReadyParcelAdapter.ViewHolder> implements CompoundButton.OnCheckedChangeListener {
...
//    boolean checkenabled=false;
    ...
    public WhReadyParcelAdapter(WhSearchParcelFragment fragment, Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
    ...
    public WhReadyParcelAdapter(Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
        this.parcelDataList = parcelDataList;
        this.onclickListener = onclickListener;
        this.context = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.whready_list_row, parent, false);

        WhReadyParcelAdapter.ViewHolder viewHolder = new WhReadyParcelAdapter.ViewHolder(itemView);
        return viewHolder;
    }
