...
public class WhSearchAdapter extends RecyclerView.Adapter<WhSearchAdapter.ViewHolder> implements CompoundButton.OnCheckedChangeListener {
    ...
    private List<ParcelListingData.ParcelData> parcelDataList;ClickListener onclickListener;
    private boolean onBind;
//    boolean checkenabled=false;


    public WhSearchAdapter(WhSearchParcelFragment fragment, Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
    ...
    public WhSearchAdapter( Context context, List<ParcelListingData.ParcelData> parcelDataList, ClickListener onclickListener) {
        this.parcelDataList = parcelDataList;
        this.onclickListener = onclickListener;
        this.context = context;
