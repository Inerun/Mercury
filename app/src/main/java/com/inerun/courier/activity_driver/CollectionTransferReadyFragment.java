...
public class CollectionTransferReadyFragment extends BaseFragment implements View.OnClickListener {


    private RecyclerView recyclerView;
    private ArrayList<PickupParcelData> pickupParcelDataArrayList;
    private CollectionTransferListingAdapter mAdapter;
    ...
    public static CollectionTransferReadyFragment newInstance() {

        Bundle args = new Bundle();

        CollectionTransferReadyFragment fragment = new CollectionTransferReadyFragment();
    ...
    public int inflateView() {
        return R.layout.activity_collection_transfer_list;
    }
    ...
    private void initView() {
        ...
        spinner = (MaterialBetterSpinner) getViewById(R.id.spn_driver);
...
//        pickupParcelDataArrayList = new ArrayList<>();
    ...
    private void setdata() {
        ...
        mAdapter = new CollectionTransferListingAdapter(activity());
...
//        recyclerView.addItemDecoration(new SimpleDividerItemDecoration(activity()));
        ...
        mAdapter.setOnItemClickListener(new CollectionTransferListingAdapter.OnItemClickListener() {
            @Override
        ...
        ArrayAdapter<DriverData> adapter = new ArrayAdapter<>(activity(), R.layout.spinner_item);
        adapter.setDropDownViewResource(R.layout.spinner_layout);
        adapter.addAll(DIHelper.getDriverList());
    ...
    private void validateData() {
        ...
        }else if(!isValidString(driver)){
            SweetAlertUtil.showSweetMessageLongToast(activity(),getString(R.string.transfer_empty_driver_msg));
        }else{
